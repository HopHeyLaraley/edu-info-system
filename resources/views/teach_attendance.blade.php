                                ...
                                <tbody>
                                    @foreach ($students as $student)
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($dates as $date)
                                                <td>
                                                    <select name="attends[{{ $student->id }}][{{ $date }}]" class="form-control bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                                        <option value="0"> </option>
                                                        <option value="exist">+</option>
                                                        <option value="no">Н</option>
                                                        <option value="late">О</option>
                                                        <option value="sick">Б</option>
                                                        <option value="reason">У</option>
                                                    </select>
                                                </td>
                                            @endforeach
                                        </tr>
